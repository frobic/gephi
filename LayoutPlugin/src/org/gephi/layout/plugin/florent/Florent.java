 ...
 */
package org.gephi.layout.plugin.florent;
...
import org.gephi.layout.plugin.florent.ForceFactory.AttractionForce;
import org.gephi.layout.plugin.florent.ForceFactory.RepulsionForce;
 ...
 */
public class Florent implements Layout {

    private GraphModel graphModel;
    private HierarchicalGraph graph;
    private final FlorentBuilder layoutBuilder;
	...
	boolean Florent_First = true;
	int commBegin = -1 ;
    //Dynamic Weight
    private TimeInterval timeInterval;
    private ExecutorService pool;

    public Florent(FlorentBuilder layoutBuilder) {
    ...
    public void initAlgo() {
        ...
        for (Node n : nodes) {
            if (n.getNodeData().getLayoutData() == null || !(n.getNodeData().getLayoutData() instanceof FlorentLayoutData)) {
    ...
    public void endAlgo() {
		for (Node n : graph.getNodes()) {
			String verif = "Florent_Virtual_Node" ;
    ...
    public LayoutProperty[] getProperties() {
        ...
        final String FORCEATLAS2_TUNING = NbBundle.getMessage(getClass(), "Florent.tuning");
        final String FORCEATLAS2_BEHAVIOR = NbBundle.getMessage(getClass(), "Florent.behavior");
        final String FORCEATLAS2_PERFORMANCE = NbBundle.getMessage(getClass(), "Florent.performance");
        final String FORCEATLAS2_THREADS = NbBundle.getMessage(getClass(), "Florent.threads");

        try {
            properties.add(LayoutProperty.createProperty(
                    this, Double.class,
                    NbBundle.getMessage(getClass(), "Florent.scalingRatio.name"),
                    FORCEATLAS2_TUNING,
                    "Florent.scalingRatio.name",
                    NbBundle.getMessage(getClass(), "Florent.scalingRatio.desc"),
                    "getScalingRatio", "setScalingRatio"));

            properties.add(LayoutProperty.createProperty(
                    this, Boolean.class,
                    NbBundle.getMessage(getClass(), "Florent.strongGravityMode.name"),
                    FORCEATLAS2_TUNING,
                    "Florent.strongGravityMode.name",
                    NbBundle.getMessage(getClass(), "Florent.strongGravityMode.desc"),
                    "isStrongGravityMode", "setStrongGravityMode"));

            properties.add(LayoutProperty.createProperty(
                    this, Double.class,
                    NbBundle.getMessage(getClass(), "Florent.gravity.name"),
                    FORCEATLAS2_TUNING,
            ...
            properties.add(LayoutProperty.createProperty(
                    this, Boolean.class,
                    NbBundle.getMessage(getClass(), "Florent.distributedAttraction.name"),
                    FORCEATLAS2_BEHAVIOR,
                    "Florent.distributedAttraction.name",
                    NbBundle.getMessage(getClass(), "Florent.distributedAttraction.desc"),
                    "isOutboundAttractionDistribution", "setOutboundAttractionDistribution"));

            properties.add(LayoutProperty.createProperty(
                    this, Boolean.class,
                    NbBundle.getMessage(getClass(), "Florent.linLogMode.name"),
                    FORCEATLAS2_BEHAVIOR,
                    "Florent.linLogMode.name",
                    NbBundle.getMessage(getClass(), "Florent.linLogMode.desc"),
                    "isLinLogMode", "setLinLogMode"));

            properties.add(LayoutProperty.createProperty(
                    this, Boolean.class,
                    NbBundle.getMessage(getClass(), "Florent.adjustSizes.name"),
                    FORCEATLAS2_BEHAVIOR,
                    "Florent.adjustSizes.name",
                    NbBundle.getMessage(getClass(), "Florent.adjustSizes.desc"),
                    "isAdjustSizes", "setAdjustSizes"));

			properties.add(LayoutProperty.createProperty(
														 this, Boolean.class,
														 NbBundle.getMessage(getClass(), "Florent.disableString.name"),
														 FORCEATLAS2_BEHAVIOR,
														 "Florent.adjustSizes.name",
														 NbBundle.getMessage(getClass(), "Florent.disableString.desc"),
														 "isDisableString", "setDisableString"));

			
            properties.add(LayoutProperty.createProperty(
                    this, Double.class,
                    NbBundle.getMessage(getClass(), "Florent.edgeWeightInfluence.name"),
                    FORCEATLAS2_BEHAVIOR,
                    "Florent.edgeWeightInfluence.name",
                    NbBundle.getMessage(getClass(), "Florent.edgeWeightInfluence.desc"),
                    "getEdgeWeightInfluence", "setEdgeWeightInfluence"));

            properties.add(LayoutProperty.createProperty(
                    this, Double.class,
                    NbBundle.getMessage(getClass(), "Florent.jitterTolerance.name"),
                    FORCEATLAS2_PERFORMANCE,
                    "Florent.jitterTolerance.name",
                    NbBundle.getMessage(getClass(), "Florent.jitterTolerance.desc"),
                    "getJitterTolerance", "setJitterTolerance"));

            properties.add(LayoutProperty.createProperty(
                    this, Boolean.class,
                    NbBundle.getMessage(getClass(), "Florent.barnesHutOptimization.name"),
                    FORCEATLAS2_PERFORMANCE,
                    "Florent.barnesHutOptimization.name",
                    NbBundle.getMessage(getClass(), "Florent.barnesHutOptimization.desc"),
                    "isBarnesHutOptimize", "setBarnesHutOptimize"));

            properties.add(LayoutProperty.createProperty(
                    this, Double.class,
                    NbBundle.getMessage(getClass(), "Florent.barnesHutTheta.name"),
                    FORCEATLAS2_PERFORMANCE,
                    "Florent.barnesHutTheta.name",
                    NbBundle.getMessage(getClass(), "Florent.barnesHutTheta.desc"),
                    "getBarnesHutTheta", "setBarnesHutTheta"));

            properties.add(LayoutProperty.createProperty(
                    this, Integer.class,
                    NbBundle.getMessage(getClass(), "Florent.threads.name"),
                    FORCEATLAS2_THREADS,
                    "Florent.threads.name",
                    NbBundle.getMessage(getClass(), "Florent.threads.desc"),
